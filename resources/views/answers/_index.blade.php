                ...
                @foreach($answers as $answer)
                    <div class="media">
                        <div class="d-fex flex-column vote-controls">
                            ...
                            <form id="up-vote-answer-{{ $answer->id }}" method="POST" style="display:none;"
                            ...
                            <form id="down-vote-answer-{{ $answer->id }}" method="POST" style="display:none;"
                                action="/answers/{{ $answer->id }}/vote">
                                @csrf
                                <input type="hidden" name="vote" value="-1">
                            </form>
                            ...
                            @else
                                ...
                                @if($answer->is_best)
                                    <a title="The qeustion owner accepted this answer as best answer"
